...
class MyWork extends Component {
  render() {
    return (
      ...
      <a href="https://github.com/anikonomova/reactnd-project-myreads-starter" target="_blank">
      ...
      <a href='https://github.com/anikonomova/Memory-game-project' target="_blank">
      ...
      <a href='https://github.com/anikonomova/Plovdiv-map' target="_blank">
      ...
      <a href="https://github.com/anikonomova/Pixel-Art-Maker-Udacity" target="_blank">
      ...
      <a href="https://github.com/anikonomova/animal-trading-card" target="_blank">
      ...
      <a href='https://github.com/anikonomova/Classic-arcade-game-clone' target="_blank">
